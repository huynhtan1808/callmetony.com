...
```
**Cập nhật**: Để biết thêm thông tin, hãy xem [Font chữ Web vào năm 2021](https://tanhuynh.io/blog/web-fonts-nam-2021).
...
[Portfolio của mình](https://github.com/tanhuynh1808/tanhuynh.io) đã thay đổi khá nhiều từ khi chỉ là trang HTML & CSS tĩnh. Sau đó, mình đổi sang dùng [Wordpress](https://wordpress.com/) 
...
được lưu trữ trên một domain nhanh đến như vậy. Bản thân mình thậm chí đã có thể thiết lập chuyển tiếp email cho domain của mình và tạo `hi@tanhuynh.io` bằng cách sử dụng [randomvmx](https://improvmx.com/) 🎉
