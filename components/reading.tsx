...
export default function ReadingProgressBar() {
  ...
  return (
    <>
    <p className="mb-2 text-sm font-medium">Mục tiêu đọc sách 2024 - {booksRead}/{totalBooks} cuốn sách</p>
    <div className="relative pt-[1px] pb-[1px] h-3 rounded-full bg-neutral-700">
      <div className="absolute top-0 left-0 h-full bg-green-400 rounded-l-full" style={{ width: `${progress}%` }}></div>
